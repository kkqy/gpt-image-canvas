...
const zhMessages = {
  ...
  canvasArrangeImages: "一键排版",
  canvasArrangeNoImages: "画布上没有可排版的图片。",
  canvasArrangeSucceeded: ({ count }: { count: number }) => `已排版 ${count} 张图片。`,
  canvasCleanupFailed: "一键清理",
  canvasCleanupNoFailed: "画布上没有生成失败的占位图。",
  canvasCleanupSucceeded: ({ count }: { count: number }) => `已清理 ${count} 张失败占位图。`,
  canvasLoadingTitle: "正在载入 gpt-image-canvas",
  canvasQuickActionsAria: "画布快捷操作",
  ...
  galleryBatchActionsLabel: "Gallery 批量操作",
  ...
  galleryBatchDeleteCancel: "取消删除",
  galleryBatchDeleteCancelled: ({ completed, total }: { completed: number; total: number }) => `已取消批量删除，已完成 ${completed}/${total} 张。`,
  galleryBatchDeleteCurrent: ({ fileName }: { fileName: string }) => `当前文件：${fileName}`,
  galleryBatchDeleteFailed: "部分图片删除失败，请重试。",
  galleryBatchDeleteFailedCount: ({ count }: { count: number }) => `${count} 张失败`,
  galleryBatchDeleteFinishedWithErrors: ({ completed, failed, total }: { completed: number; failed: number; total: number }) =>
    `批量删除完成 ${completed}/${total} 张，${failed} 张失败。`,
  galleryBatchDeleteOverall: ({ percent }: { percent: number }) => `总体进度 ${percent}%`,
  galleryBatchDeletePreparing: "正在准备删除...",
  galleryBatchDeleteProcessed: ({ count, total }: { count: number; total: number }) => `已处理 ${count}/${total} 张`,
  galleryBatchDeleteProgressTitle: ({ completed, total }: { completed: number; total: number }) => `正在删除 ${completed}/${total}`,
  galleryBatchDeleteTitle: ({ count }: { count: number }) => `删除 ${count} 张 Gallery 图片？`,
  galleryBatchDownload: "下载选中",
  galleryBatchDownloadCancel: "取消下载",
  galleryBatchDownloadCancelled: ({ completed, total }: { completed: number; total: number }) => `已取消批量下载，已完成 ${completed}/${total} 张。`,
  galleryBatchDownloadCurrent: ({ fileName }: { fileName: string }) => `当前文件：${fileName}`,
  galleryBatchDownloadCurrentBytes: ({ loaded, percent, total }: { loaded: string; percent: number; total: string }) => `${loaded} / ${total} (${percent}%)`,
  galleryBatchDownloadFailedCount: ({ count }: { count: number }) => `${count} 张失败`,
  galleryBatchDownloadFinished: ({ count }: { count: number }) => `已下载 ${count} 张图片。`,
  galleryBatchDownloadFinishedWithErrors: ({ completed, failed, total }: { completed: number; failed: number; total: number }) =>
    `批量下载完成 ${completed}/${total} 张，${failed} 张失败。`,
  galleryBatchDownloadLoaded: ({ loaded }: { loaded: string }) => `已下载 ${loaded}`,
  galleryBatchDownloadOverall: ({ percent }: { percent: number }) => `总体进度 ${percent}%`,
  galleryBatchDownloadPreparing: "正在准备下载...",
  galleryBatchDownloadProgressTitle: ({ completed, total }: { completed: number; total: number }) => `正在下载 ${completed}/${total}`,
  ...
  gallerySelectCurrent: "全选当前结果",
  gallerySelectedCount: ({ count }: { count: number }) => `已选择 ${count} 张`,
  gallerySelectImage: ({ excerpt }: { excerpt: string }) => `选择 Gallery 图片：${excerpt}`,
  ...
  generationDownloadOpened: "已开始下载原始资源。",
...
const enMessages: I18nMessages = {
  ...
  canvasArrangeImages: "Auto arrange",
  canvasArrangeNoImages: "There are no images to arrange on the canvas.",
  canvasArrangeSucceeded: ({ count }) => `${count} images arranged.`,
  canvasCleanupFailed: "Clean failed",
  canvasCleanupNoFailed: "There are no failed generation placeholders on the canvas.",
  canvasCleanupSucceeded: ({ count }) => `${count} failed placeholders cleaned.`,
  canvasLoadingTitle: "Loading gpt-image-canvas",
  canvasQuickActionsAria: "Canvas quick actions",
  ...
  galleryBatchActionsLabel: "Gallery batch actions",
  ...
  galleryBatchDeleteCancel: "Cancel delete",
  galleryBatchDeleteCancelled: ({ completed, total }) => `Batch delete cancelled. Completed ${completed}/${total} images.`,
  galleryBatchDeleteCurrent: ({ fileName }) => `Current file: ${fileName}`,
  galleryBatchDeleteFailed: "Some images could not be deleted. Try again.",
  galleryBatchDeleteFailedCount: ({ count }) => `${count} failed`,
  galleryBatchDeleteFinishedWithErrors: ({ completed, failed, total }) => `Batch delete completed ${completed}/${total} images, ${failed} failed.`,
  galleryBatchDeleteOverall: ({ percent }) => `Overall progress ${percent}%`,
  galleryBatchDeletePreparing: "Preparing delete...",
  galleryBatchDeleteProcessed: ({ count, total }) => `Processed ${count}/${total} images`,
  galleryBatchDeleteProgressTitle: ({ completed, total }) => `Deleting ${completed}/${total}`,
  galleryBatchDeleteTitle: ({ count }) => `Delete ${count} Gallery images?`,
  galleryBatchDownload: "Download selected",
  galleryBatchDownloadCancel: "Cancel download",
  galleryBatchDownloadCancelled: ({ completed, total }) => `Batch download cancelled. Completed ${completed}/${total} images.`,
  galleryBatchDownloadCurrent: ({ fileName }) => `Current file: ${fileName}`,
  galleryBatchDownloadCurrentBytes: ({ loaded, percent, total }) => `${loaded} / ${total} (${percent}%)`,
  galleryBatchDownloadFailedCount: ({ count }) => `${count} failed`,
  galleryBatchDownloadFinished: ({ count }) => `Downloaded ${count} images.`,
  galleryBatchDownloadFinishedWithErrors: ({ completed, failed, total }) => `Batch download completed ${completed}/${total} images, ${failed} failed.`,
  galleryBatchDownloadLoaded: ({ loaded }) => `Downloaded ${loaded}`,
  galleryBatchDownloadOverall: ({ percent }) => `Overall progress ${percent}%`,
  galleryBatchDownloadPreparing: "Preparing download...",
  galleryBatchDownloadProgressTitle: ({ completed, total }) => `Downloading ${completed}/${total}`,
  ...
  galleryOpenDownload: "Original download started.",
  ...
  gallerySelectCurrent: "Select current results",
  gallerySelectedCount: ({ count }) => `${count} selected`,
  gallerySelectImage: ({ excerpt }) => `Select Gallery image: ${excerpt}`,
  ...
  generationDownloadOpened: "Original resource download started.",
