...
const zhMessages = {
  ...
  galleryBatchDeleteBody: ({ count }: { count: number }) =>
    `将从 Gallery、生成历史、画布和本地资源中移除 ${count} 张选中图片。此操作不可撤销。`,
  ...
  galleryCanvasRemoved: ({ count }: { count: number }) => `已从画布移除 ${count} 张关联图片。`,
  ...
  gallerySelectCurrent: "选择当前结果",
  gallerySelectImage: ({ excerpt }: { excerpt: string }) => `选择图片：${excerpt}`,
...
const enMessages: I18nMessages = {
  ...
  galleryBatchDeleteBody: ({ count }) =>
    `Remove ${count} selected images from Gallery, generation history, canvas, and local assets. This cannot be undone.`,
  ...
  galleryCanvasRemoved: ({ count }) => `Removed ${count} linked images from the canvas.`,
  ...
  gallerySelectImage: ({ excerpt }) => `Select image: ${excerpt}`,
